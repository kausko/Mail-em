...
import ExampleTable, {
	table,
} from "../components/MailForm/UploadCSV/ExampleTable"
	...
	return (
		...
		>
			...
			<VStack align="flex-start">
				...
				<Text>
					Upload a text or html file containing the message that you
					intend to send in the email body
				</Text>
			</VStack>
			...
			<VStack align="flex-start">
				...
				<Text>
					All constraints and limits setup by Gmail are applicable.
					SVG files can be used as templates by adding variables in
					the code.
				</Text>
				<Text>
					PRO TIP: Presentation programs like PowerPoint, Slides,
					Keynote, etc. support exporting slides as SVG files.
				</Text>
			</VStack>
			<Image
				src="/code.svg"
